 ...
 * Side-by-side grid: upcoming-events list (left) and testimonial
 * quotes (right).
 *
            ...
            {upcomingEvents.slice(0, 2).map((event, index) => (
              ...
              >
                <div className="relative aspect-[16/10]">
                  <Image src={event.image} alt={event.title} fill sizes="(max-width: 767px) 86vw, (max-width: 1023px) 50vw, 28vw" className="object-cover" />
                </div>
                <div className="p-5">
