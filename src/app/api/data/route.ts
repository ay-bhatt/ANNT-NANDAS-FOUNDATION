...
export async function GET() {
  try {
    const all: AllData = {
      ...
      volunteerOpportunities: D.volunteerOpportunities.map(({ image, ...item }) => ({
        ...item,
      ...
      homeMoments: D.homeMoments.map((moment) => ({ ...moment, src: img(moment.src) })),
      pageVisuals: {
        ourWorkHero: img(D.pageVisuals.ourWorkHero),
        ourWorkCta: img(D.pageVisuals.ourWorkCta),
        programsHero: img(D.pageVisuals.programsHero),
        programsCta: img(D.pageVisuals.programsCta),
        eventsHero: img(D.pageVisuals.eventsHero),
        eventsCta: img(D.pageVisuals.eventsCta),
        galleryHero: img(D.pageVisuals.galleryHero),
        galleryCta: img(D.pageVisuals.galleryCta),
        donateHero: img(D.pageVisuals.donateHero),
        donateCta: img(D.pageVisuals.donateCta),
        contactHero: img(D.pageVisuals.contactHero),
        contactCta: img(D.pageVisuals.contactCta),
        newsCta: img(D.pageVisuals.newsCta),
        homeCta: img(D.pageVisuals.homeCta),
        overviewPrimary: img(D.pageVisuals.overviewPrimary),
        overviewSecondary: img(D.pageVisuals.overviewSecondary),
        aboutHero: img(D.pageVisuals.aboutHero),
        aboutCta: img(D.pageVisuals.aboutCta),
        communityRooted: img(D.pageVisuals.communityRooted),
      },
